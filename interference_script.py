# Script for the inference experiment

"""
The script contains the parameters for the Inference experiment.
THis experiment is designed to test the effect of different target angles and perturbation regimes on the motor learning
process.
...
def update_parameters(attempts,event):
    ...
    # target angles
    if attempts == 0:
        script_parameters['sequence_target'] = -40
    elif attempts == 100:
        script_parameters['sequence_target'] = 60
    elif attempts == 200:
        script_parameters['sequence_target'] = -90
